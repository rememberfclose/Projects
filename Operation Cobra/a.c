...
int uzo=1;
	...
	for (int i = 0; i < 20; ++i)
	{
		...
		{	
			...
			if((goal[1]==1 && goal[0]==8)||(goal[1]==18 && goal[0]==10)||(goal[1]==1 && goal[0]==9)||(goal[1]==3 && goal[0]==5) || (goal[1]==15 && goal[0]==18)|| (goal[0]==7 && goal[1]==17) || (goal[0]==18 && goal[1]==1) || (goal[0]==2 && goal[1]==5) || (goal[0]==14 && goal[1]==3) || goal[0]==0 || goal[0]==19 || goal[0]+goal[1]==27 || goal[0]+goal[1]==13 || goal[1]==0 || goal[1]==20 || (goal[0]==5+goal[1] && goal[1]<5) || (goal[0]==-4+goal[1] && goal[1]>=9 && goal[1]<16))
				{goal[1]=(goal[1]+2)%20;
				goal[0]=(goal[0]+2)%20;}
