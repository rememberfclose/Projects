	...
	for (int i = 0; i < 20; ++i)
	{
		...
		{	
			if(goal[0]==starti && goal[1]==startj) {
				...
				if(starti==0 || starti==19 || starti+startj==27 || starti+startj==13 || startj==0 || startj==20 || (starti==5+startj && startj<5) || (starti==-4+startj && startj>=9 && startj<16))
				{startj=oldj;
					starti=oldi;
					health-=10;
					if(health==0)
			...
			if((goal[1]==18 && goal[0]==10)||(goal[1]==1 && goal[0]==9)||(goal[1]==3 && goal[0]==5) || (goal[1]==15 && goal[0]==18)|| (goal[0]==7 && goal[1]==17) || (goal[0]==18 && goal[1]==1) || (goal[0]==2 && goal[1]==5) || (goal[0]==14 && goal[1]==3) || goal[0]==0 || goal[0]==19 || goal[0]+goal[1]==27 || goal[0]+goal[1]==13 || goal[1]==0 || goal[1]==20 || (goal[0]==5+goal[1] && goal[1]<5) || (goal[0]==-4+goal[1] && goal[1]>=9 && goal[1]<16))
				{goal[1]=(goal[1]+2)%20;
				goal[0]=(goal[0]+2)%20;}
			if(startj==18 && starti==10){
				startj=2;
				starti=9;
			}
			if(startj==1 && starti==9){
				starti=2;
				startj=6;
			}
			if(startj==1 && starti==8 && uzo==1)
			{	
				health=100;
				uzo--;
			}

			if(starti==2 && startj==5)
			{
				starti=14;
				startj=4;
			}

			if(starti==14 && startj==3)
			{
				starti=2;
				startj=6;
			}
			if(starti==7 && startj==17)
			{
				starti=18;
				startj=2;
			}

			if(starti==18 && startj==1)
			{
				starti=7;
				startj=18;
			}
			if(starti==5 && startj==3)
			{
				starti=18;
				startj=16;
			}

			if(starti==18 && startj==15)
			{
				starti=5;
				startj=4;
			}
			if(j==1 && i==8 && uzo)
				printf("❤");
			else if((j==18 && i==10) ||(j==1 && i==9) || (j==3 && i==5)||(j==15 && i==18)||(j==5 && i==2) || (i==14 && j==3) || (i==7 && j==17) || (i==18 && j==1))
				printf("I");
			else if(j==goal[1] && i==goal[0])
			printf("+");
			else if(i==0 || i==19 || i+j==27 || i+j==13 || j==0 || j==20 || (i==5+j && j<5) || (i==-4+j && j>=9 && j<16))
				printf("#");
			else if(j==startj && i==starti)
			printf("%c", '*');
			else
